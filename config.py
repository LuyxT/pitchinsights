...
class SecurityConfig:
    ...
    # Data Directory - EINFACHE LOGIK
    # Railway: Nutze /tmp (immer schreibbar) - Volume muss via Env-Var konfiguriert werden
    # Lokal: Nutze "data"
    _IS_RAILWAY = os.path.exists("/app")
    DATA_DIR: str = os.environ.get(
        "PITCHINSIGHTS_DATA_DIR",
        "/tmp/pitchinsights_data" if _IS_RAILWAY else "data"
    )
